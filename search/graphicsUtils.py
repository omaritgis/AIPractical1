...
def keys_pressed(d_o_e=lambda arg: _root_window.dooneevent(arg), #Tkinter.tkinter.dooneevent, <-- original code
...
if __name__ == '__main__':
    ...
    move_to(g, (50, 50))
    circle((150, 150), 20, formatColor(0.7, 0.3, 0.0), formatColor(0.3, 0.7, 0.0), endpoints=[15, - 15], style="pieslice",width=2)
    sleep(2)
