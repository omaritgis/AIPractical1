...
class SearchAgent(Agent):
    ...
    def __init__(self, fn='depthFirstSearch', prob='PositionSearchProblem', heuristic='nullHeuristic'):
        ...
        if fn not in dir(search):
            ...
            print(fn + ' is not a search function in search.py.')
        ...
        if 'heuristic' not in func.func_code.co_varnames:
            ...
            if heuristic in globals().keys():
                ...
                raise AttributeError
                print(heuristic + ' is not a function in searchAgents.py or search.py.')
        ...
        if prob not in globals().keys() or not prob.endswith('Problem'):
            raise AttributeError
            print(prob + ' is not a search problem type in SearchAgents.py.')
...
##        self.newCornerState = {}
##        self.cornerVisited = []
##        self.nodesVisited = startingGameState.getPacmanPosition()
##        for corner in self.corners:
##            if corner == self.startingPosition:
##                #self.cornerVisited.append((corner,True))
##                self.newCornerState[corner]=True
##            else:
##                #self.cornerVisited.append((corner,False))
##                self.newCornerState[corner]=False
##        self.cornerVisited = tuple(self.cornerVisited)
##        print self.newCornerState
    ...
    def getStartState(self):
        ...
        space)
        """
        # Start state would be starting position of pacman and corners visited.
##        return (self.startingPosition)
    ...
    def isGoalState(self, state):
        ...
        """
##        c = 0;
##        # Goal state will be achieved if all the corner have been visited.
##        iscornerVisited = True
##        for corner in self.newCornerState.values():
##            if corner == False:
##            return False
...
def cornersHeuristic(state, problem):
    ...
    #     if cornerState[1][1] == False:
    #         counterT = counterT + 1
        
    #     position = state[0]
    #     corPosition = corner

    #     distance =  (abs(corPosition[0][0] - position[0]) + abs(corPosition[0][1] - position[1]))
...
def myMazeDistance(point1, point2, problem):
    """
    ...
    prob = PositionSearchProblem(problem, start=point1, goal=point2, warn=False, visualize=False)
        ...
        while(currentState.getFood().count() > 0):
            ...
            for action in nextPathSegment:
                ...
                if action not in legal:
                    ...
                    raise Exception
                    print('findPathToClosestDot returned an illegal move: %s!\n%s' % t)
